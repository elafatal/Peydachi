...
const ErrorPage = () => {
    ...
    return (
        <>
            ...
            <main>
        <section class="bg-gray-950 relative max-w-screen  flex justify-center items-center h-screen ">
            <div class="mx-auto  px-4 sm:px-6 lg:px-8 relative">
                ...
                <div class=" w-full mx-auto h-auto text-center mb-7">
                    <div class="w-full h-auto mx-auto py-8 rounded-2xl">
                        ...
                        <p class="font-medium text-md leading-9 text-blue-600 text-center mb-6">صفحه ای که به دنبال آن هستید وجود ندارد یا منتقل شده است</p>
